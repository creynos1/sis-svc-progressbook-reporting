...
# only grab bin output from ExagoSchedulerSetup project
$srcPath = join-path $Env:TF_BUILD_SOURCESDIRECTORY "Third Party Integration\ExagoSchedulerSetup\ExagoSchedulerSetup\bin" 
